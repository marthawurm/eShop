...
class SellersControllerTest < ActionController::TestCase
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post :create, seller: { email: @seller.email, name: @seller.name, phone_number: @seller.phone_number, town: @seller.town, web_address: @seller.web_address }
    end
  ...
  test "should update seller" do
    put :update, id: @seller, seller: { email: @seller.email, name: @seller.name, phone_number: @seller.phone_number, town: @seller.town, web_address: @seller.web_address }
    assert_redirected_to seller_path(assigns(:seller))
  end
